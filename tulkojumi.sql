...
-- 
-- Hosts: localhost
-- Izveidošanas laiks: 09.01.2015 20:54
...
INSERT INTO `vardi` VALUES (25, 'Ko tas nozīmē?', 'What does it mean?', 'Что это значит?', '.o');
...
INSERT INTO `vardi` VALUES (34, 'Cik pulkstens?', 'What time is it?', 'Сколько сейчас времени?', '.a?j');
